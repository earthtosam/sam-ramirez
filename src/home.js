...
import HeroImage from './images/sf_images/hero_section_image.png';

function Home() {
    return (
        <div>
            <section class="hero">
                <div class="hero-container col-lg-6 col-sm-12 col-12 mt-5">
                    ...
                    <ul class="button-container">
                        <li><a href="sam-ramirez/#/restaurants">Start</a></li>
                    </ul>
                </div>
                <div class="hero-image col-lg-6 col-sm-12 col-12 mt-5">
                    <img src={HeroImage} />
                </div>
                <div>
            ...
            <section class="story">
                <div class="story-container">
                    ...
                    <div class="text-container col-lg-6 col-sm-12">
                        ...
                        <a href="sam-ramirez/#/about">See Team</a>
                    </div>
                </div>
            </section>
        </div>
